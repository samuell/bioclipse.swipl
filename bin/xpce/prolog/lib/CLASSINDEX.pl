...
class(identifier_item, text_item, 'Item for non-empty, canonised word', 'pce_identifier_item.pl').
...
class(prolog_preferences, dialog, 'Edit the default preferences', 'swi_preferences.pl').
