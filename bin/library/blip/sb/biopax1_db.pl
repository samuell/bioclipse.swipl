...
:-module(biopax1_db, [physicalEntityParticipant/1, chemicalStructure/1, openControlledVocabulary/1, dataSource/1, xref/1, pathwayStep/1, bioSource/1, utilityClass/1, rna/1, physicalEntity/1, smallMolecule/1, complex/1, protein/1, relationshipXref/1, unificationXref/1, publicationXref/1, control/1, conversion/1, interaction/1, entity/1, complexAssembly/1, biochemicalReaction/1, transport/1, pathway/1, modulation/1, catalysis/1, transportWithBiochemicalReaction/1, physical_entity/2, cellular_location/2, organism/2, participants/2, controller/2, controlled/2, tissue/2, taxon_xref/2, celltype/2, step_interactions/2, structure/2, components/2, pathway_components/2, xref/2, cofactor/2, right/2, data_source/2, next_step/2, left/2, stoichiometric_coefficient/2, sequence/2, db/2, id/2, relationship_type/2, control_type/2, db_version/2, id_version/2, biopax1_db_name/2, short_name/2, structure_data/2, structure_format/2, spontaneous/2, year/2, title/2, chemical_formula/2, molecular_weight/2, direction/2, availability/2, biopax1_db_comment/2, term/2, synonyms/2, source/2, authors/2, delta_h/2, delta_g/2, keq/2, url/2, ec_number/2, delta_s/2, op(300, xfy, physical_entity), op(300, xfy, cellular_location), op(300, xfy, organism), op(300, xfy, participants), op(300, xfy, controller), op(300, xfy, controlled), op(300, xfy, tissue), op(300, xfy, taxon_xref), op(300, xfy, celltype), op(300, xfy, step_interactions), op(300, xfy, structure), op(300, xfy, components), op(300, xfy, pathway_components), op(300, xfy, xref), op(300, xfy, cofactor), op(300, xfy, right), op(300, xfy, data_source), op(300, xfy, next_step), op(300, xfy, left), op(300, xfy, stoichiometric_coefficient), op(300, xfy, sequence), op(300, xfy, db), op(300, xfy, id), op(300, xfy, relationship_type), op(300, xfy, control_type), op(300, xfy, db_version), op(300, xfy, id_version), op(300, xfy, biopax1_db_name), op(300, xfy, short_name), op(300, xfy, structure_data), op(300, xfy, structure_format), op(300, xfy, spontaneous), op(300, xfy, year), op(300, xfy, title), op(300, xfy, chemical_formula), op(300, xfy, molecular_weight), op(300, xfy, direction), op(300, xfy, availability), op(300, xfy, biopax1_db_comment), op(300, xfy, term), op(300, xfy, synonyms), op(300, xfy, source), op(300, xfy, authors), op(300, xfy, delta_h), op(300, xfy, delta_g), op(300, xfy, keq), op(300, xfy, url), op(300, xfy, ec_number), op(300, xfy, delta_s)]).
...
biopax1_db:biopax1_db_name(G6461, G6464):-rdf_has(G6461, 'http://www.biopax.org/release/biopax-level1.owl#NAME', G6524), rdf_literal_to_native(G6524, G6464).
...
biopax1_db:biopax1_db_comment(G6461, G6464):-rdf_has(G6461, 'http://www.biopax.org/release/biopax-level1.owl#COMMENT', G6524), rdf_literal_to_native(G6524, G6464).
