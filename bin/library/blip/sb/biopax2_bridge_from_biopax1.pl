...
biopax2_db:bp_name(G6581, G6584):-rdf_has(G6581, 'http://www.biopax.org/release/biopax-level1.owl#NAME', G6644), rdf_literal_to_native(G6644, G6584).
...
biopax2_db:bp_comment(G6581, G6584):-rdf_has(G6581, 'http://www.biopax.org/release/biopax-level1.owl#COMMENT', G6644), rdf_literal_to_native(G6644, G6584).
