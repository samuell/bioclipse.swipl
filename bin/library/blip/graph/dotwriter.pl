...
/** <module> maps graph structures to dot format
  ...
  % (note: dotwriter does not use these facts directly)
...
using imagemagick, or transformed into pngs etc using Dotwriter
programs 'dot' and 'neatto'
  ...
  AT&T Dotwriter (the 'dot' or 'neato' executable)
